...
(async() => {
    ...
    const index = Files.duplicateTextFile(`${__dirname}/expressAppStarter.js`, `${cwd}/index.js`);
    const router = Files.duplicateTextFile(`${__dirname}/expressRootRouter.js`, `${cwd}/rooter/rootRouter.js`);
    return result;
